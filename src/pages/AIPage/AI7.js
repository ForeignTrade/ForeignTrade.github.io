        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, padding: 2 }}>
          <Box sx={{ display: 'flex', justifyContent: 'flex-start' }}>
            ...
            <Typography sx={{ marginLeft: 1, marginRight: 1, padding: 1, backgroundColor: '#e0e0e0', borderRadius: 2 }}>
              欢迎使用需求预测助手。为了帮助您准确预测市场需求，优化库存管理并提高客户满意度，请提供以下信息：<br />
              您所经营的产品或服务类型：<br />
              过去一段时间的销售数据或需求数据（如果有）：<br />
              您当前的需求预测方法和工具（如果有）：<br />
              您面临的主要需求预测挑战或困难：<br />
              您希望助手关注的特定需求预测方面，如季节性波动、市场趋势分析等：<br />
              其他任何您认为重要的信息，如新产品上市计划、市场竞争情况等：<br />
              这些信息将帮助我们为您提供精准的需求预测模型和建议，以帮助您更好地规划生产和库存，满足市场需求并提高您的业务效率。
